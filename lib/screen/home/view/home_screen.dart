  ...
  Widget build(BuildContext context) {
    return Scaffold(
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              ...
                              leading: CircleAvatar(
                                backgroundColor:
                                    homeController.isTheme.value == true
                                        ? fav
                                        : c1,
                                child: Text(
                                  "${homeController.userList[index].name![0]}",
                                  style:
                              ...
                              subtitle: Text(
                                "${homeController.userList[index].mobile}",
      ...
      floatingActionButton: FloatingActionButton(
        foregroundColor:
            homeController.isTheme == true ? Colors.white : Colors.black,
        backgroundColor: homeController.isTheme == true ? fav : c1,
        onPressed: () {
          Get.toNamed('/user');
        },
